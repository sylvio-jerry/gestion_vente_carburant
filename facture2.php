<?php 
    include('operation.facture3.php');
                    ...
                    <div class="btn">
                        <form action="" method="post">
                            <button type="submit" id="exportFactureExcel" name='exportFactureExcel'
                                value="Excel" class="btn btn-info">
                                Excel
                            </button>
                            <button type="submit" id="exportFacturePdf" name='exportFacturePdf'
                                value="Pdf" class="btn btn-success">
                                Pdf
                            </button>
                        </form>
                    </div>
                    <div class="row tablef">
                        <table id="tablefacture" class="table table-bordered" id='tableFacture'>
                            <thead>
                                <tr>
                                    <th>CARBURANT</th>
                                    <th>PU</th>
